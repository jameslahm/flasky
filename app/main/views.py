...
from flask import request,flash,session,current_app, render_template, abort,redirect, url_for,make_response
from . import main
from .forms import CommentForm,PostForm,NameForm,EditProfileForm,EditProfileAdminForm
from .. import db
from ..models import User,Comment,Role
from ..decorators import permission_required,admin_required
from flask_login import login_required,current_user
from ..models import Permission,Post,Follow
...
def post(id):
    ...
    return render_template('post.html',form=form,comments=comments,posts=[post],pagination=pagination)
